...
static bool mic_frame_has_activity(const uint8_t *data, size_t len)
{
    ...
    constexpr size_t MIN_ACTIVE_SAMPLES = 5;
...
static constexpr int64_t THINKING_DELAY_US = 700000; // 700 ms after user stops
...
extern "C" void app_main()
{
    ...
    // FACE_IDLE: system is ready; face_animation now owns idle animation.
    face_set_state(FACE_IDLE);
